...
var HomePage = /** @class */ (function () {
    function HomePage(loadingController, storage, router, menuCtrl, restService, popoverController, oneSignal, socialSharing) {
    ...
    HomePage.prototype.getDropDownData = function () {
        ...
        this.restService.getDdlData(stringy).subscribe(function (response) {
            ...
            console.log("get currency", _this.response);
    ...
    HomePage.prototype.inviteFrnds = function () {
