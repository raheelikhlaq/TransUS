...
var ListYourCarPage = /** @class */ (function () {
    ...
    ListYourCarPage.prototype.uploadDocumentsPhotossss = function (params) {
        this.paramsTesting(params);
    };
    ListYourCarPage.prototype.paramsTesting = function (params) {
        if (params == '1') {
    ...
    ListYourCarPage.prototype.singleCallingImgs = function () {
        var options = {
